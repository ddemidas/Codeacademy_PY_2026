...
'''
# Your code below: 
data_science_topics_removed=[str(data_science_topics.pop())]
print("This topic has been removed: ")
print(data_science_topics_removed)
print("These topics are still within the course of Data Science: ")
print(data_science_topics)
...
'''
data_science_topics_removed = data_science_topics_removed + [str(data_science_topics.pop(3))]
print("This topic has been removed: ")
print(data_science_topics_removed)
print("These topics are still within the course of Data Science: ")
print(data_science_topics)
