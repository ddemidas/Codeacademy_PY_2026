...
def estimated_time_rounded(estimated_time):
  ...
  return rounded_time
estimate = estimated_time_rounded(3.75)
print("Estimated time rounded: ")
print(estimate)
'''
task3
...
def destination_setup(origin, destination, estimated_time, mode_of_transport = "Car"):
  ...
  #in this print Codeacademy engine again shows brutal inflexibility, the task was not counted as done while doublequotes were part of string.
  print("It will take approximately "  + str(estimated_time) + " hours")
  
destination_setup("Danzig", "Frankfurt", estimate)
